...
const defaultValues = {
  password: 'azertyuiop1230',
  email: 'adil.nouiri13@gmail.com'
}
...
const LoginPage = () => {
  ...
  const onSubmit = () => {
    auth.login({ username: values.username, password: values.password }, () => { // rememberMe
      setError('email', {
        type: 'manual',
          ...
          <CardContent sx={{ p: theme => `${theme.spacing(10.5, 8, 8)} !important` }}>
            ...
            <form noValidate autoComplete='off' onSubmit={e => e.preventDefault()}>
              <CustomTextField
                ...
                sx={{ mb: 4 }}
                placeholder='adil.nouiri13@gmail.com'
              />
              <CustomTextField
                fullWidth
                sx={{ mb: 1.5 }}
